...
?>
	<div id="perfilBolsaTrabajo" class="contSelRolUsuario selActivo">
			<div class="titleSelRol">Bolsa de trabajo</div>
			...
			<div id="mibolsa" class="thingsConteiner4">
				...
				<script>
$('#mibolsa').load('php/bolsaAlumnoAcciones.php', { accion:'listar' });
</script>
			</div>
		<div>
		</div>
...
function previewWork(id) {
	...
	$('#editDeEmergencia').load('php/bolsaAlumnoAcciones.php', { accion:'preview', campo1 : id });
	showEditBolsa();
}
