...
?>
	<div id="perfilBolsaTrabajo" class="contSelRolUsuario selActivo">
			<div class="titleSelRol">Carreras</div>
			...
			<div id="mibolsa" class="thingsConteiner5">
				...
				<script>
$('#mibolsa').load('php/adminABMCarrerasAccion.php');
</script>
			</div>
		<div>
		</div>
...
function disableCareer(id) {
	...
	if (confirmar == true) {
		$('#mibolsa').load('php/adminABMCarrerasAccion.php', { accion: "disable", campo1 : id });
	}
	else return;
...
function enableCareer(id) {
	...
	if (confirmar == true) {
		$('#mibolsa').load('php/adminABMCarrerasAccion.php', { accion: "enable", campo1 : id });
	}
	else return;
}
